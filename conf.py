...
# -*- coding: utf-8 -*-
#
# Guida per scrivere una Guida by Roberto Ceccarelli - The Strawberry Field
...
man_pages = [
    (master_doc, 'guide_guide', 'Guida per scrivere una Guida',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'guide_guide', 'Guida per scrivere una Guida',
   author, 'guide_guide', 'Guida per scrivere una Guida',
   'Miscellaneous'),
]
